...
# file:    cn_xml_doc.py
# author:  rbw
# date:    Sat Jan 13 17:50:20 PST 2018
...
class CnXmlDocument():
    ...
    def __init__(self, xml_file_arg="", xml_str_arg="", debug_arg=False):
        if ((len(xml_file_arg) < 1) and len(xml_str_arg) < 1):
            print('cn_xml_doc ERROR: either "xml_file_arg" or "xml_str_arg" args must be defined')
            return Null
